...
public class RemarkController {
    ...
    public List<Remark> removeAllRemarksByUserId(@RequestBody String userId){
    	return remarkService.removeAllRemarksByUserId(userId);
    }
    
    @RequestMapping("/removeOneRemarksByUserId")
    public List<Remark> removeOneRemarksByUserId(@RequestBody String userId,  int remarkId){
